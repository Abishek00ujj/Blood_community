    ...
    <div class="bg-slate-200 min-h-screen flex items-center justify-center">
      ...
      <div className="text-justify mt-12">
        <p className="text-xl text-gray-600">
          We are currently pursuing our 3rd year of BTech-IT at Sri Shakthi College, working together to build this Blood Community as part of our MERN stack project. Our goal is to create a reliable, user-friendly platform that helps users plan their trips effortlessly.
        </p>
      </div>
      <hr/>
      <div className="text-justify mt-12">
